...
def train_model(args, fold_split):
    ...
    # Skip GradCAM for models with frozen features as they cause gradient computation issues
    if not args.freeze_features:
        ...
        print("Skipping GradCAM visualization for frozen models")
        grad_cam_dir = os.path.join(args.output_dir, args.model_name, f'fold_{fold_split["fold_num"]}', 'grad_cam')
